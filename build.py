...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/dodger_plane/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/dodger_plane/archive/master.zip", tmp)
    file += "master"
